...
export default function AuthPage() {
  ...
  return (
    <div className="flex h-full w-full min-w-[375px] flex-1 flex-col items-center justify-center p-0 transition-[padding] ease-in-out lg:px-32 lg:py-16 xl:px-64">
